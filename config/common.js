module.exports = {
    ...
    cdnThirdParty: {
        jquery: '/vendor-cdn/jquery@3.7.1/dist/jquery.min.js',
        bootstrapCSS: '/vendor-cdn/bootstrap@3.3.7/dist/css/bootstrap.min.css',
        bootstrapJS: '/vendor-cdn/bootstrap@3.3.7/dist/js/bootstrap.min.js',
        lodash: '/vendor-cdn/lodash@3.10.1/index.min.js',
        paceProgressBarJS: '/vendor-cdn/pace-js@1.2.4/pace.min.js',
        sweetalertJS: '/vendor-cdn/sweetalert@2.1.2/dist/sweetalert.min.js',
        echartsMinJS_4_8_0: '/vendor-cdn/echarts@4.8.0/dist/echarts.min.js',
        prettifyJS: '/vendor-cdn/code-prettify@0.1.0/src/prettify.min.js',
        // Can not find good prettify css in jsdelivr.
        // prettifyCSS: '/vendor-cdn/code-prettify@0.1.0/styles/doxy.css',
        prettifyCSSHandlerJS: '/vendor-cdn/code-prettify@0.1.0/src/lang-css.js',

        // CDN for doc
        vueJS: '/vendor-cdn/vue@2.6.14/dist/vue.min.js',
        elementUIJS: '/vendor-cdn/element-ui@2.15.14/lib/index.js',
        elementUICSS: '/vendor-cdn/element-ui@2.15.14/lib/theme-chalk/index.css',
        codeMirrorJS: '/vendor-cdn/codemirror@5.56.0/lib/codemirror.js',
        codeMirrorJSModeJS: '/vendor-cdn/codemirror@5.56.0/mode/javascript/javascript.js',
        beautifierJS: '/vendor-cdn/js-beautify@1.11.0/js/lib/beautifier.min.js',
    },
    ...
    cdnThirdPartyCN: {
        ...
        bootstrapCSS: '/vendor-cdn/bootstrap@3.3.7/dist/css/bootstrap.min.css',
        bootstrapJS: '/vendor-cdn/bootstrap@3.3.7/dist/js/bootstrap.min.js',
        lodash: '/vendor-cdn/lodash.js/3.10.1/lodash.min.js',
        paceProgressBarJS: '/vendor-cdn/pace@1.2.4/pace.min.js',
        sweetalertJS: '/vendor-cdn/sweetalert@2.1.2/dist/sweetalert.min.js',
        echartsMinJS_4_8_0: '/vendor-cdn/echarts@4.8.0/dist/echarts.min.js',
        prettifyJS: '/vendor-cdn/code-prettify@0.1.0/src/prettify.js',
        prettifyCSSHandlerJS: '/vendor-cdn/code-prettify@0.1.0/src/lang-css.js',
