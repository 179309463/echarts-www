...
export declare const version = "5.5.2-dev.20240911";
...
export declare type EChartsInitOpts = {
 ...
 */
export declare function init(dom?: HTMLElement | null, theme?: string | object | null, opts?: EChartsInitOpts): EChartsType;
/**
 * @usage
 * (A)
 * ```js
